...
describe("resolveCiIdentity", () => {
  test("resolves GitLab merge-request pipeline with hostname", async () => {
    expect(
  ...
  test("resolves GitHub pull_request workflow with hostname", async () => {
    expect(
      await resolveCiIdentity(
        deps({
