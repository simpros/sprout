...
[Preview labels](previews.md#preview-labels-adopter-supplied-container-labels)).
...
Operator symptoms below. The full catalogue (adopter + operator) lives in
...
- [Adopting a repo](adopting-a-repo.md) — `.sprout.yaml`, app entrypoint
- [CI integration](ci-integration.md) — CI workflows
